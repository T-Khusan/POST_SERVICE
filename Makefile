...
migration-up:
	migrate -path ./migrations/postgres -database 'postgres://postgres:123@0.0.0.0:5432/ss_go_corporate_service?sslmode=disable' up

migration-down:
	migrate -path ./migrations/postgres -database 'postgres://postgres:123@0.0.0.0:5432/ss_go_corporate_service?sslmode=disable' down
build:
